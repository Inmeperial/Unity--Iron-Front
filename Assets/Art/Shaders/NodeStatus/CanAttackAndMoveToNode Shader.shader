...
Shader "CanAttackAndMoveToNode Shader"
{
	Properties
	{
		...
		_MinBright("MinBright", Range( 0 , 1)) = 0.2
		_MaxBright("MaxBright", Range( 0 , 1)) = 0.9
		[IntRange]_TimeCicle("TimeCicle", Range( 0 , 10)) = 4
	...
	SubShader
	{
		...
		uniform float _TimeCicle;
		uniform float _MinBright;
		uniform float _MaxBright;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float mulTime8 = _Time.y * _TimeCicle;
			float clampResult12 = clamp( sin( mulTime8 ) , _MinBright , _MaxBright );
			o.Emission = saturate( ( ( ( _ColorMove * tex2DNode4.g ) + ( tex2DNode4.b * _ColorAttack ) ) * clampResult12 ) ).rgb;
			o.Alpha = saturate( clampResult12 );
		}
...
/*ASEBEGIN
Version=17800
0;73;579;938;2131.338;1794.749;3.988213;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-1249.856,381.9769;Inherit;False;Property;_TimeCicle;TimeCicle;5;1;[IntRange];Create;True;0;0;False;0;4;8;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;8;-1010.577,479.09;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-1120.237,-1018.406;Inherit;False;Property;_ColorMove;ColorMove;2;1;[HDR];Create;True;0;0;False;0;0,0.9367321,1,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;11;-1133.764,679.0859;Inherit;False;Property;_MaxBright;MaxBright;4;0;Create;True;0;0;False;0;0.9;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1129.007,571.1345;Inherit;False;Property;_MinBright;MinBright;3;0;Create;True;0;0;False;0;0.2;0.178;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-393.4484,-260.3704;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;15;-156.6532,-143.9821;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=9B5698B62EE893C7F00707932EA49467A77152A1