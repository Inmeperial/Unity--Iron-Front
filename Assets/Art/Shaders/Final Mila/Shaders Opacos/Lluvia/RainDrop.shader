...
Shader "RainDrop"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_35_0_g3 = frac( ( ( Tiempo94 + clampResult42_g3 ) / totalFrames39_g3 ) );
			float2 appendResult29_g3 = (float2(temp_output_35_0_g3 , ( 1.0 - temp_output_35_0_g3 )));
			float2 temp_output_15_0_g3 = ( ( appendResult19.xy / appendResult7_g3 ) + ( floor( ( appendResult8_g3 * appendResult29_g3 ) ) / appendResult7_g3 ) );
			float3 NormalesGoteo67 = BlendNormals( UnpackScaleNormal( tex2D( _Texture0, temp_output_15_0_g4 ), Mascara40 ) , UnpackScaleNormal( tex2D( _Texture0, temp_output_15_0_g3 ), Mascara40 ) );
...
/*ASEBEGIN
Version=17800
16;256;1807;763;-1097.22;326.0414;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-2782.41,-1397.516;Inherit;False;Property;_Speed;Speed;2;0;Create;True;0;0;False;0;8;14;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=613124FFC01BCEF78B8ACF5AD63E474F8C56E8B1