...
Shader "MasterShader"
{
	Properties
	{
		...
		_Float3("Float 3", Range( 0 , 5)) = 3.374926
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 EmissionVar46 = (( _IsEmissionON )?( ( tex2D( _TextureEmission, uv_TextureEmission ) * _Float3 ) ):( float4( 0,0,0,0 ) ));
...
/*ASEBEGIN
Version=17800
0;73;811;938;2667.462;454.5747;2.257923;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1635.145,563.7399;Inherit;False;Property;_Float3;Float 3;8;0;Create;True;0;0;False;0;3.374926;3.847574;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;49;-1213.36,407.9516;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;44;-1956.134,-2571.754;Inherit;True;Property;_MaskAlbedo;MaskAlbedo;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0C49BACAB9828B458D548E53C57ADE8E5519F216