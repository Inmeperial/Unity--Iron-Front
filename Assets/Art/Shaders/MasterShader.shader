...
Shader "MasterShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 EmissionVar46 = (( _IsEmissionON )?( ( tex2D( _TextureEmission, uv_TextureEmission ) * 2.0 ) ):( float4( 0,0,0,0 ) ));
...
/*ASEBEGIN
Version=17800
0;73;811;938;2588.482;1060.571;2.855772;True;False
...
ASEEND*/
//CHKSM=44379A523ED06D4F97C5C6B06B5EBA5635CB2927