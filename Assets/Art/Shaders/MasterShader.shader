...
Shader "MasterShader"
{
	Properties
	{
		...
		_TextureAlbedo1("TextureAlbedo", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _TextureAlbedo1;
		uniform float4 _TextureAlbedo1_ST;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TextureAlbedo1 = i.uv_texcoord * _TextureAlbedo1_ST.xy + _TextureAlbedo1_ST.zw;
			...
			float clampResult10 = clamp( sin( mulTime3 ) , 0.1 , 0.7 );
				...
				float4 staticSwitch20 = (( _isWeapon )?( tex2D( _TextureAlbedo1, uv_TextureAlbedo1 ) ):( ( tex2D( _TextureAlbedo, uv_TextureAlbedo ) * _ColorAlbedo ) ));
			#elif defined(_SwitchTexture_Key1)
				float4 staticSwitch20 = ( (( _isWeapon )?( tex2D( _TextureAlbedo1, uv_TextureAlbedo1 ) ):( ( tex2D( _TextureAlbedo, uv_TextureAlbedo ) * _ColorAlbedo ) )) + ( fresnelNode6 * color7 ) );
			#elif defined(_SwitchTexture_Key2)
				float4 staticSwitch20 = ( (( _isWeapon )?( tex2D( _TextureAlbedo1, uv_TextureAlbedo1 ) ):( ( tex2D( _TextureAlbedo, uv_TextureAlbedo ) * _ColorAlbedo ) )) + clampResult10 );
			#else
				float4 staticSwitch20 = (( _isWeapon )?( tex2D( _TextureAlbedo1, uv_TextureAlbedo1 ) ):( ( tex2D( _TextureAlbedo, uv_TextureAlbedo ) * _ColorAlbedo ) ));
			#endif
...
/*ASEBEGIN
Version=17800
0;0;1920;1029;2749.768;1617.67;1.368813;True;False
...
Node;AmplifyShaderEditor.ColorNode;22;-2355.833,-1029.175;Inherit;False;Property;_ColorAlbedo;ColorAlbedo;5;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-2156.874,-1299.917;Inherit;True;Property;_TextureAlbedo;TextureAlbedo;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;31;-1886.751,-677.8389;Inherit;True;Property;_TextureAlbedo1;TextureAlbedo;1;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;23;-1777.501,-1005.628;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;30;-1435.139,-861.0194;Inherit;False;Property;_isWeapon;isWeapon;6;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;17;-535.601,221.8007;Inherit;True;Property;_TextureNormal1;TextureNormal;2;0;Create;True;0;0;False;0;-1;None;a1eab61512be39f43a87676bb8e919a6;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-596.7444,728.7391;Inherit;True;Property;_TextureMask;TextureMask;4;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;16;-590.6254,483.6395;Inherit;True;Property;_TextureEmission1;TextureEmission;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=7993AD033F6FC0C903494C960138E656F156AE39