...
public class AnimationMechaHandler : MonoBehaviour
{
    ...
    private MechaExhaust _particleMechaHandler;
    ...
    private void Start()
    {
        ...
        _particleMechaHandler = GetComponent<MechaExhaust>();
    ...
    //    if (_character.GetBody().CurrentHP <= 0)
    ...
    //{
    //    if (_deadAnimIsActive || _animator.GetBool("isReciveDamageAnimator"))
    //        return;
