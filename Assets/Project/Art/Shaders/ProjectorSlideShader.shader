...
Shader "ProjectorSlideShader"
{
	Properties
	{
		_TexturePic("TexturePic", 2D) = "white" {}
		_InnerRedLines("InnerRedLines", Range( 0 , 1)) = 0.7580875
		_TextureFrame("TextureFrame", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _TexturePic;
		uniform sampler2D _FramePic;
		uniform sampler2D _TextureFrame;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode111 = tex2D( _FramePic, panner97 );
			float temp_output_112_0 = ( 1.0 - tex2DNode111.a );
			float4 tex2DNode93 = tex2D( _TextureFrame, panner97 );
			float4 lerpResult94 = lerp( tex2DNode93 , float4( 0,0,0,0 ) , tex2DNode93);
			float4 temp_output_91_0 = ( ( 1.0 - AnimTransitionVar84 ) * ( ( tex2D( _TexturePic, panner97 ) * temp_output_112_0 ) + lerpResult94 ) );
			float4 ImgAndTransVar130 = temp_output_91_0;
			float testingFrame134 = temp_output_112_0;
			float4 lerpResult133 = lerp( float4( 0,0,0,0 ) , ImgAndTransVar130 , testingFrame134);
...
/*ASEBEGIN
Version=17800
-1692;39;1264;936;-1074.591;4705.926;3.933041;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;34;3099.431,-1738.441;Inherit;False;Property;_InnerRedLines;InnerRedLines;1;0;Create;True;0;0;False;0;0.7580875;0.7580875;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;129;2407.905,-3916.524;Inherit;False;2405.977;1402.531;;20;130;91;89;123;85;110;94;112;93;1;111;97;99;109;98;108;134;137;138;139;Image and Transition;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.StepOpNode;36;3122.792,-1505.46;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;111;3171.207,-3255.147;Inherit;True;Property;_FramePic;FramePic;13;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;112;3500.298,-3292.769;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;3186.255,-3547.51;Inherit;True;Property;_TexturePic;TexturePic;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;85;3540.742,-3831.158;Inherit;True;84;AnimTransitionVar;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;89;3833.256,-3726.901;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;130;4657.315,-3553.696;Inherit;False;ImgAndTransVar;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;134;3741.647,-3069.716;Inherit;False;testingFrame;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;135;1270.244,-436.9331;Inherit;False;134;testingFrame;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;131;1220.385,-576.7015;Inherit;False;130;ImgAndTransVar;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;2835.004,378.3515;Inherit;False;Property;_Power2;Power2;7;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;137;4154.521,-3821.142;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;138;4429.938,-3599.165;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;133;1591.685,-674.4417;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;2831.852,1178.27;Inherit;False;Property;_Power3;Power3;10;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;7;3251.587,-910.2642;Inherit;False;Property;_ColorOfVintage;ColorOfVintage;2;0;Create;True;0;0;False;0;0.7075472,0.3654875,0.1435119,0;1,0.2436809,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;73;2803.523,1018.271;Inherit;False;Property;_Scale3;Scale3;9;0;Create;True;0;0;False;0;0;10;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;30;3558.106,-748.657;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;2806.675,218.3518;Inherit;False;Property;_Scale2;Scale2;6;0;Create;True;0;0;False;0;0;6.88;5;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;2841.032,-443.3386;Inherit;False;Property;_Power;Power;4;0;Create;True;0;0;False;0;0;0.65;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;95;2347.469,-769.3765;Inherit;False;Property;_Keyword0;Keyword 0;12;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;125;3932.409,-4125.666;Inherit;False;Property;_Color0;Color 0;14;0;Create;True;0;0;False;0;1,1,1,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;139;4090.785,-2764.792;Inherit;True;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;6;2812.703,-603.3381;Inherit;False;Property;_Scale;Scale;3;0;Create;True;0;0;False;0;0;8.6;0;10;0;1;FLOAT;0
...
WireConnection;139;0;111;4
WireConnection;139;1;94;0
WireConnection;0;0;133;0
ASEEND*/
//CHKSM=B3373DDB0DBEFBF8D7BF6ACBE5353449DBD433BB