...
Shader "ProjectorSlideShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 ImgAndTransVar130 = ( ( 1.0 - AnimTransitionVar84 ) * ( tex2D( _TexturePic, panner97 ) * ( 1.0 - tex2D( _FramePic, panner97 ).a ) ) );
...
/*ASEBEGIN
Version=17800
-1434;36;1264;930;-1667.33;1094.252;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;3186.255,-3547.51;Inherit;True;Property;_TexturePic;TexturePic;0;0;Create;True;0;0;False;0;-1;None;30b35836961494847924cb77d0431799;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5F3EDC7D656114195296FB1D2F805AC63798245C